                        ...
                        <div class="col-8">
                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-body box-profile">
                                    ...
                                    <form>
                                        <fieldset disabled>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="number" class="form-control" id="nik" value="<?= session()->get('nik') ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="phone" class="col-sm-2 col-form-label">Phone</label>
                                                <div class="col-lg-8">
                                                    <input type="number" class="form-control" id="phone" value="<?= session()->get('phone') ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                    ...
                                    <center>
                                        <a href="/dashboard/updateprofile/<?= session()->get('id'); ?>" class="btn btn-primary btn-block col-lg-3 mb-3"><b>Edit</b></a>
                                    </center>
                                </div>
                                <!-- /.card-body -->
                            </div>
