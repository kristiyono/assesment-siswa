                ...
                <div class="container-fluid">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <a href="/assesment" class="btn btn-primary mb-3">Create Assesment</a>
                                    ...
                                    <tbody>
                                        <?php foreach ($kuis as $item) : ?>
                                            <tr>
                                                ...
                                                <td style="width: 30%"><?= $item->periode; ?></td>
                                                ...
                                                <td style="width: 40%">
                                                    ...
                                                    <button type="button" id="info" data-toggle="modal" data-target="#modal_detail" data-namakelas="<?= $item->nama_kelas; ?>" data-periode="<?= $item->periode; ?>" data-namametode="<?= $item->nama_metode; ?>" class="btn btn-primary"><i class="fa fa-eye"></i>Detail</button>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
